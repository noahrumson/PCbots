...
try: 
    ...
    lidar0_process = subprocess.Popen(['./runme1'], stdout = subprocess.PIPE) 
    std_output = lidar0_process.communicate()[0] 
    ...
    lidar0_process = subprocess.Popen(['./runme2'], stdout = subprocess.PIPE) 
    std_output = lidar0_process.communicate()[0] 
    ...
    lidar0_process = subprocess.Popen(['./runme3'], stdout = subprocess.PIPE) 
    std_output = lidar0_process.communicate()[0] 
